...
**实战案例：60 行精简法**（Ali 厂长 2026-05 实践分享）：

社区实践表明，将 root CLAUDE.md 压到 60 行以内能显著提升 Claude 遵从度并降低维护成本。压不下来的根本原因往往是把"全局约束"和"模块/场景规则"混在一处。三步可行做法：
...
- `raw/ai-chat/claude_md_complete_guide.md`
- `raw/wechat/微信视频号内容总结文档.md`（Ali 厂长 2026-05-12 视频号分享）
